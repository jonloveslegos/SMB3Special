...
local seesawSettings = {
	...
	isWeightBased = true, -- Whether or not the NPC's rotation is affected by objects on top of it.
	maxAngle = 45,        -- The maximum angle the NPC will go to before bouncing back up. (Only affects weight-based platforms.)
