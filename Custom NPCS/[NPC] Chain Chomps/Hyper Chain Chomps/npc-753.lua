...
local chainChompSettings = {
	...
	maxDistance = 192,   -- Maximum distance chomp can go before being pulled back by chains.
	roamDistance = 120,  -- How far the chomp will hop before turning around.
	lungeDistance = 144, -- How close a player has to be to be lunged at.
