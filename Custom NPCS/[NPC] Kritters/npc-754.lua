...
local kritterSettings = {
	...
	bounces = 2,       -- The amount of bounces the NPC does before a larger jump. (Only affects blue and black kritters.)
	bounceYSpeed = -3, -- The Y speed the NPC gets when bouncing before a larger jump. (Only affects blue and black kritters.)
